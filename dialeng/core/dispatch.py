...
Usage:
    ...
    from dialeng.core.dispatch import render_cell, cell_to_llm_messages
...
def cell_to_jupyter(cell: 'Cell') -> dict:
    ...
    from dialeng.document.serialization import _cell_to_jupyter
...
def jupyter_to_cell(jcell: dict, index: int = 0) -> 'Cell':
    ...
    from dialeng.document.serialization import _jupyter_to_cell
...
def _default_prompt_renderer(cell: 'Cell', notebook_id: str):
    ...
    from dialeng.ui.cells.prompt_cell import PromptCellView
